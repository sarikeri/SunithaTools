...
{
    public abstract class DalBaseRepository<T> : IDalBaseRepository<T>
    {
        ...
        protected void ExecuteNonQuery(string sqlStmt, Action<OracleCommand> fnPrepareCommand, OracleConnection conn)
        {
