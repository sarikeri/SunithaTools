...
config.trackingDetailAPI = 'http://webservices-stage.dsstage.drugstore.com/packagetrackingservice/v1/TrackingDetail?ClientId=${clientId}&SiteId=${siteId}&OrderId=${orderId}&ShippingDateTime=${shippingDateTime}&CarrierId=${carrierId}&TrackingId=${trackingId}';

config.trackingDetailAPITimeOut = 6000;

config.eventGeneratorAPI = 'http://webservices-stage.dsstage.drugstore.com/eventgenerator/v1/event';
