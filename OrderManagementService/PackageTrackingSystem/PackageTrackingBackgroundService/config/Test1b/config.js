...
config.trackingDetailAPI = 'http://webservices-t1b.dstest.drugstore.com/packagetrackingservice/v1/TrackingDetail?ClientId=${clientId}&SiteId=${siteId}&OrderId=${orderId}&ShippingDateTime=${shippingDateTime}&CarrierId=${carrierId}&TrackingId=${trackingId}';

config.trackingDetailAPITimeOut = 6000;

config.eventGeneratorAPI = 'http://webservices-t1b.dstest.drugstore.com/eventgenerator/v1/event';
