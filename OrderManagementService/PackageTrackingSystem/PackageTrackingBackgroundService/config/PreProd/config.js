...
config.trackingDetailAPI = 'http://packagetrackingservice.dvdmzwalgreenco.net/packagetrackingservice/v1/TrackingDetail?ClientId=${clientId}&SiteId=${siteId}&OrderId=${orderId}&ShippingDateTime=${shippingDateTime}&CarrierId=${carrierId}&TrackingId=${trackingId}';

config.trackingDetailAPITimeOut = 6000;

config.eventGeneratorAPI = 'http://eventgeneratorservice.dvdmzwalgreenco.net/eventgenerator/v1/event';
