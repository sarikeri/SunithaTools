...
config.trackingDetailAPI = 'http://packagetrackingservice.dmzwalgreenco.net/packagetrackingservice/v1/TrackingDetail?ClientId=${clientId}&SiteId=${siteId}&OrderId=${orderId}&ShippingDateTime=${shippingDateTime}&CarrierId=${carrierId}&TrackingId=${trackingId}';

config.trackingDetailAPITimeOut = 6000;

config.eventGeneratorAPI = 'http://eventgeneratorservice.dmzwalgreenco.net/eventgenerator/v1/event';
