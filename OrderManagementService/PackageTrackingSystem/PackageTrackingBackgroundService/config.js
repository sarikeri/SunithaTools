...
config.logging = {
    logDirectory: 'C:\\logroot\\PackageTrackingBackgroundService',
    verboseLogFileName: 'Verbose.log',
    errorLogFileName: 'Error.log',
    debugLogFileName: 'Debug.log',
    suppressDebugInfoLog: false
};
...
config.terminalTrackingStatuses = ["Delivered", "NotDeliverable"];
...
config.trackingDetailAPI = 'http://hqomsws01t.corp.drugstore.com/packagetrackingservice/v1/TrackingDetail?ClientId=${clientId}&SiteId=${siteId}&OrderId=${orderId}&ShippingDateTime=${shippingDateTime}&CarrierId=${carrierId}&TrackingId=${trackingId}';

config.trackingDetailAPITimeOut = 3000;

config.eventGeneratorAPI = 'http://localhost/eventgenerator/v1/event';

config.eventGeneratorAPITimeOut = 3000;

config.retryWaitMins = 1;