...
class addWorkflow {
    ...
    execute() {
        return new Promise(function (resolve, reject) {
            ...
            let promises = [];
            try {
                if (context.shouldAddCloseOrderWF || context.shouldAddBackOrderWF || context.shouldAddShipReqWF) {
                    ...
                    } else if (context.hasOwnProperty("shouldAddShipReqWF") && context.shouldAddShipReqWF == true) {
                        data = {};
                        data.name = "SoftAllocated";
                        data.version = "v1";
                        data.tags = ['suborderId'];
                        data.metadata = {}
                        data.metadata.orderId = metadata.orderId;
                    ...
                    if (context.SuborderEvent.status) {
                        ...
                        suborderEventData.name = (context.SuborderEvent.Event == constants.suborderEvents.SoftAllocated) ?
                            "SuborderSoftAllocatedEvent" : "SuborderCancelledEvent";
